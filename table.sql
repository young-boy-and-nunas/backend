...
create table cheer (cheer_seq bigint not null auto_increment, contents varchar(255), img_url varchar(255), user_seq bigint not null, worry_seq bigint not null, primary key (cheer_seq)) engine=InnoDB;
...
create table worry (worry_seq bigint not null auto_increment, contents varchar(255), img_url varchar(255), user_seq bigint not null, primary key (worry_seq)) engine=InnoDB;
